...
class LineitemsControllerTest < ActionController::TestCase
  ...
  test "should create lineitem" do
    assert_difference('Lineitem.count') do
      post :create, lineitem: { quantity: @lineitem.quantity, unit_price: @lineitem.unit_price }
    end
  ...
  test "should update lineitem" do
    put :update, id: @lineitem, lineitem: { quantity: @lineitem.quantity, unit_price: @lineitem.unit_price }
    assert_redirected_to lineitem_path(assigns(:lineitem))
  end
